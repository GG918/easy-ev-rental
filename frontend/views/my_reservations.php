<?php
include_once '../../backend/core/Database.php';
include_once '../../backend/core/auth.php';
// Include helper functions if they exist
if (file_exists('../../backend/includes/helpers.php')) {
...
<body>
                ...
                <?php if ($isLoggedIn): ?>
                    <li class="user-menu">
                        ...
                        <div class="user-menu-content">
                            ...
                            <a href="#" onclick="alert('Track feature coming soon!')">Track</a>
    ...
    <script src="../public/js/my_reservations.js"></script>
</body>
</html> 