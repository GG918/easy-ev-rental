...
const AuthService = {
    ...
    async login(username, password) {
        return this.sendRequest('login.php', 'POST', { username, password });
    },
    ...
    async register(username, email, password) {
        return this.sendRequest('register.php', 'POST', { username, email, password });
    },
    ...
    async logout() {
        try {
            const result = await this.sendRequest('logout.php', 'POST');
            if (result.success) {
